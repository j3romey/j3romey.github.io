...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'hi.data';
    var REMOTE_PACKAGE_BASE = 'hi.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 17345420;
      var PACKAGE_UUID = '0a09db0d-c32e-46fb-83ed-c9513c95680e';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 20808, 0, 0).open('GET', '/globalgamemanagers');
    new DataRequest(20808, 32272, 0, 0).open('GET', '/globalgamemanagers.assets');
    new DataRequest(32272, 42836, 0, 0).open('GET', '/level0');
    new DataRequest(42836, 54160, 0, 0).open('GET', '/level1');
    new DataRequest(54160, 54414, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(54414, 57578, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(57578, 7818742, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(7818742, 7882914, 0, 0).open('GET', '/sharedassets1.assets');
    new DataRequest(7882914, 13953107, 0, 0).open('GET', '/sharedassets1.resource');
    new DataRequest(13953107, 15759695, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(15759695, 17257067, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(17257067, 17317795, 0, 0).open('GET', '/Resources/unity_builtin_extra');
    new DataRequest(17317795, 17345420, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_hi.data');

    };
    Module['addRunDependency']('datafile_hi.data');
